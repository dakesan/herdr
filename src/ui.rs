...
pub(crate) use self::sidebar::{
    agent_panel_entries_from, expanded_sidebar_sections_with_agent_panel, resolved_token_spans,
    sidebar_agent_rows, sidebar_section_divider_rect_with_agent_panel, sidebar_space_rows,
