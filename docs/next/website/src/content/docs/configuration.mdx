...
To give Spaces the full height of the desktop sidebar, hide the Agents panel:
...
This setting affects both expanded and collapsed desktop sidebars. Agent detection,
notifications, keyboard actions, API views, and the mobile Agents view remain available.
